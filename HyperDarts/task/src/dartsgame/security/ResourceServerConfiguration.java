...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    String publicKey = "-----BEGIN PUBLIC KEY-----" +
            "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDQ+7yKlJGuvYtf1soMsJjkQJGAXe90QAxqppycf+3JT5ehnvvWtwS8ef+UsqrNa5R" +
            "c9tyyHjP7ZXRN145SlRTZzc0d03Ez10OfAEVdhGACgRxS5s+GZVtdJuVcje3Luq3VIvZ8mV/P4eRcV3yVKDwQEenMuL6Mh6JLH48Kxg" +
            "bNRQIDAQAB" +
            "-----END PUBLIC KEY-----";
    ...
    public void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .access("(#oauth2.hasScope('read') and hasRole('ROLE_GAMER') or hasRole('ROLE_REFEREE'))")
                .antMatchers(HttpMethod.POST, "/**")
                .access("(#oauth2.hasScope('write') and hasRole('ROLE_GAMER') or hasRole('ROLE_REFEREE'))")
